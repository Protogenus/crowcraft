...
import { AdvancedHarvestingTools } from "./advanced-harvesting-tools";
...
export class RuneThemedStall extends Item {
    constructor() {
        super(
            "rune themed stall",
            ...
            [
				...
				new CraftingMaterial(1, new AdvancedHarvestingTools()),
            ],
            1,
            ""
        );
