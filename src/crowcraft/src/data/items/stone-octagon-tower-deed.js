...
export class StoneOctagonTowerDeed extends Item {
    constructor() {
        super(
            "stone octagon tower deed",
            [Professions.Stonemason],
            [Rarities.Common, Rarities.Uncommon, Rarities.Rare, Rarities.Epic, Rarities.Legendary],
            [
                new CraftingMaterial(16, new StoneWallSection()),
				new CraftingMaterial(1, new QualityAssuranceControlKit()),
				new CraftingMaterial(8, new FoundationSegment()),
				new CraftingMaterial(10, new CarpentryNails()),
				new CraftingMaterial(8, new ArchitecturalArches()),
				new CraftingMaterial(10, new RoofSegment()),
