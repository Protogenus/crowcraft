...
export class SigilAxe extends CustomizableComponent {
    constructor() {
        super(
            "sigil: axe",
...
class BeneficialHarvestChanceSigilAxeCustomization extends Customization {
    constructor() {
        super(
...
class HarvestCriticalChanceSigilAxeCustomization extends Customization {
    constructor() {
        super(
...
class PlethoraOfDustSigilAxeCustomization extends Customization {
    constructor() {
        super(
            "plethora of dust",
            [
...
class ForagedFruitChanceSigilAxeCustomization extends Customization {
    constructor() {
        super(
            ...
            {
                [Rarities.Common.name]: [ItemsStats.ForagedFruitChance],
                [Rarities.Uncommon.name]: [ItemsStats.ForagedFruitChance],
                [Rarities.Rare.name]: [ItemsStats.ForagedFruitChance],
                [Rarities.Epic.name]: [ItemsStats.ForagedFruitChance],
                [Rarities.Legendary.name]: [ItemsStats.ForagedFruitChance],
            }
        )
    }
}
