...
export class SigilHammer extends CustomizableComponent {
    constructor() {
        super(
            "sigil: hammer",
...
class BeneficialHarvestChanceSigilHammerCustomization extends Customization {
    constructor() {
        super(
...
class HarvestCriticalChanceSigilHammerCustomization extends Customization {
    constructor() {
        super(
...
class PlethoraOfDustSigilHammerCustomization extends Customization {
    constructor() {
        super(
            "plethora of dust",
            [
...
class MineralHarvestChanceSigilHammerCustomization extends Customization {
    constructor() {
        super(
            ...
            {
                [Rarities.Common.name]: [ItemsStats.MineralHarvestChance],
                [Rarities.Uncommon.name]: [ItemsStats.MineralHarvestChance],
                [Rarities.Rare.name]: [ItemsStats.MineralHarvestChance],
                [Rarities.Epic.name]: [ItemsStats.MineralHarvestChance],
                [Rarities.Legendary.name]: [ItemsStats.MineralHarvestChance],
            }
        )
    }
}
